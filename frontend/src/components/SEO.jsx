...
const SEO = ({ 
  ...
  description = "Meet thoughtful readers in small groups. Discuss books you actually finished. Deep conversations, over coffee. 4 readers, 1 book, 1 table. Available in 9 cities across India. ₹499 per meetup.",
